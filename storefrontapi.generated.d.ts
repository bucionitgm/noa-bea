...
export type ProductVariantDetailsFragment = Pick<
  StorefrontAPI.ProductVariant,
...
export type FeaturedProductItemFragment = Pick<
  StorefrontAPI.Product,
...
export type FirstProductItemFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle' | 'vendor' | 'description'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type FirstProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FirstProductQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment FirstProductItem on Product {\n    id\n    title\n    handle\n    vendor\n    description\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    variants(first: 1) {\n      nodes {\n        id\n        availableForSale\n        price {\n          amount\n          currencyCode\n        }\n      }\n    }\n  }\n\n  query FirstProduct(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: 1, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...FirstProductItem\n      }\n    }\n  }\n': {
    return: FirstProductQuery;
    variables: FirstProductQueryVariables;
  };
